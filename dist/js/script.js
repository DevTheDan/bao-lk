$(document).ready(function(){
  ...
  $('#language').on('click', function() {
    ...
    $('.circle:nth-child(4)').toggleClass('circle_active');
    $('.circle__arrow').toggleClass('circle__arrow_active');
  });
  ...
  $('#notify').on('click', function() {
    ...
    $('#notify').toggleClass('circle_active');
  });

  $('.language__block').each(function(i) {
    $(this).on('click', function() {
      $('.header__right-language span').text($('.language__block').eq(i).text());
    });
  });
  ...
  $(document).mouseup(function (e) {
    ...
    if (container.has(e.target).length === 0){
      $('.reinvest').removeClass('reinvest_active');      
    }
  });

  $('.trigger').on('click', function() {
    $('.reinvest').addClass('reinvest_active');
  });
  ...
  $('.tab').on('click', function() {
    $(this)
      ...
      .closest('body').find('div.tab__content').removeClass('tab__content_active').eq($(this).index()).addClass('tab__content_active');
      $('.menu').removeClass('active');
      $('body').css('overflow', '');
  });

  $('.language__block').on('click', function() {
    $(this)
      .addClass('language__block_active').siblings().removeClass('language__block_active');
  });
...
// dropdown
  ...
  $('.s').on('click', function() {
    if (document.documentElement.clientWidth < 860) {
      $('.tariff__card-body_s').toggleClass('hide');
      $('.tariff__card-body_m').addClass('hide');
      $('.tariff__card-body_l').addClass('hide');
      $('.s').toggleClass('br22');
      $('.m').addClass('br22');
      $('.l').addClass('br22');
  ...
  $('.m').on('click', function() {
    if (document.documentElement.clientWidth < 860) {
      $('.tariff__card-body_m').toggleClass('hide');
      $('.tariff__card-body_s').addClass('hide');
      $('.tariff__card-body_l').addClass('hide');
      $('.s').addClass('br22');
      $('.m').toggleClass('br22');
      $('.l').addClass('br22');
  ...
  $('.l').on('click', function() {
    if (document.documentElement.clientWidth < 860) {
      $('.tariff__card-body_l').toggleClass('hide');
      $('.tariff__card-body_s').addClass('hide');
      $('.tariff__card-body_m').addClass('hide');
      $('.s').addClass('br22');
      $('.m').addClass('br22');
